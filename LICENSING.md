...
A `LICENSE-openllmetry` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [traceloop/openllmetry](https://github.com/traceloop/openllmetry), Copyright
the traceloop/openllmetry authors, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../openllmetry-port/specs/SPEC-001-openllmetry.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
